...
const report = {
  ...
  perRtAll,
  pemukiman: {
    totalWarga: statsPemukiman.totalWarga,
    kelompokUsia: statsPemukiman.kelompokUsia,
    perRt: statsPemukiman.perRt,
    pengangguran: statsPemukiman.pengangguran,
  },
  seluruhRw: {
    kelompokUsia: statsAll.kelompokUsia,
    pengangguran: statsAll.pengangguran.total,
    perRt: statsAll.perRt,
  },
  kualitasData: {
