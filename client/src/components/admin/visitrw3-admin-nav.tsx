...
const NAV_TABS: TabDef[] = [
  { href: "/admin/visitrw3/dashboard", label: "Dashboard" },
...
function isActive(location: string, href: string, exact?: boolean) {
  if (href === "/admin/visitrw3/dashboard") {
    return location === "/admin/visitrw3/dashboard" || location === "/admin/visitrw3";
  }
...
function tabLinkHref(href: string) {
  return href === "/admin/visitrw3/dashboard" ? "/admin/visitrw3" : href;
}
