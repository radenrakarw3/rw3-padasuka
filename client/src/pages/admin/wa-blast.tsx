                  ...
                  <div className="space-y-1.5">
                    <div className="flex items-center gap-1.5">
                      ...
                      <p className="text-[11px] font-semibold text-blue-700 uppercase tracking-wide">
                        Anak &lt; 16 Tahun ({anakList.length})
                      </p>
                    </div>
                    <div className="p-2.5 rounded-lg bg-blue-50 border border-blue-200">
                      <p className="text-[11px] text-blue-700 mb-2.5 leading-snug">
                        Warga di bawah ini berusia &lt; 16 tahun dan dianggap belum memiliki WhatsApp. Tidak perlu diisi.
                      </p>
                      <div className="space-y-1.5">
                        {anakList.map(w => (
